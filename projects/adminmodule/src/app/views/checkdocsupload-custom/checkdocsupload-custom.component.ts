...
@Component({
  selector: 'app-checkdocsupload-custom',
  templateUrl: './checkdocsupload-custom.component.html',
//   styleUrls: ['./pdfcell-custom.component.css']
})
export class CheckDocsUploadCustomComponent implements OnInit,ICellRendererAngularComp {
...
this.params.context.componentParent.DeleteData(selectedNode.data);
  ...
  onModal(){
    ...
    let selectedData = selectedNode.data;
    this.params.context.componentParent.ViewDocsImage(selectedNode.data);
  }
