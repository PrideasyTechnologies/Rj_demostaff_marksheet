...
@Component({
  selector: 'app-downloadcell-custom',
  templateUrl: './downloadcell-custom.component.html',
  //   styleUrls: ['./pdfcell-custom.component.css']
})
export class DownloadCellCustomComponent implements OnInit, ICellRendererAngularComp {
  ...
  execute() {
    ...
    this.params.context.componentParent.DownloadCell(selectedNode.data);
  }
